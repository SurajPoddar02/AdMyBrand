...
const ERC1967Proxy_json_1 = __importDefault(require("../extendedArtifacts/ERC1967Proxy.json"));
                ...
                if (typeof options.proxy.proxyContract === 'string') {
                    ...
                    if (!proxyContract || proxyContract === EIP173Proxy_json_1.default) {
                        if (options.proxy.proxyContract === 'EIP173ProxyWithReceive') {
                            ...
                            proxyContract = ERC1967Proxy_json_1.default;
            ...
            if (!proxy) {
                ...
                if (proxyAdminName) {
                    ...
                    if (changeImplementationMethod === 'upgradeToAndCall' &&
                        !updateMethod) {
                        executeReceipt = await execute(name, Object.assign(Object.assign({}, options), { from }), 'upgradeTo', implementation.address);
                    }
                    else {
                        executeReceipt = await execute(name, Object.assign(Object.assign({}, options), { from }), changeImplementationMethod, implementation.address, data);
                    }
                    if (!executeReceipt) {
                        throw new Error(`could not execute ${changeImplementationMethod}`);
                    }
